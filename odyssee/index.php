...
/* 		 
														   ...
														   .                     .cCCc:... ::              .:..    .     .   ..                :Cc....cooOc::.. .      .         .  
															 ...
															 ::.               .:oCoCo:.                .oc::cc:                           .cC::cc:::ccccccooooooOOooc:::::.     
...
$_SESSION['last_version'] = "V2024-07-02.10h00" ; 

// *****************************************************************************
// *****                       Historique des versions                     *****
// *****************************************************************************
// ***** V1.0    	- 2024/07/02 - Premiere version
// *****         	- Ecriture du code - sur les cendre de la version "desir" en HTML/PHP/Javascript/bootstrap
...
*/	
	...
	if (!isset($_SESSION['login']) || ($_SESSION['login']=="")) {
		header ('Location: authentication/sign-up/index.php');
		exit();
	}

	if (!file_exists("pages/connexion.php")) {	header ('Location: 404.html');	exit();		}	else {		include "pages/connexion.php";	}
	if (!file_exists("pages/fonctions.php")) {	header ('Location: 404.html');	exit();		}	else {		include "pages/fonctions.php";	}
...
<!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
	...
	<script>
	// Frame-busting pour empêcher le chargement du site dans un cadre sans autorisation (click-jacking)
			...
			<div class="d-flex align-items-center flex-stack flex-grow-1">
				...
				<div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">  
					...
					<a href="index.php" class="app-sidebar-logo">
						<img alt="Logo" src="assets/media/logos/logo_hibiscus.png" class="h-60px theme-light-show"/>
						<img alt="Logo" src="assets/media/logos/logo_hibiscus-dark.png" class="h-60px theme-dark-show"/>
					</a>
					<!-- <h1 class="fw-bold text-gray-800" style="margin-left: -33px;margin-top: 12px;">Extranet</h1> -->
					<!--end::Logo-->   
    
					<!--begin::Sidebar toggle-->
					<div id="kt_app_sidebar_toggle" class="app-sidebar-toggle btn btn-sm btn-icon btn-color-warning me-n2 d-none d-lg-flex active" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
			...
			<div class="row gx-5 gx-xl-10">
				...
				<div class="col-xxl-6 mb-5 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-5">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column"><span class="card-label fw-bold text-dark">Titre</span> <span class="text-gray-400 mt-1 fw-semibold fs-6">Petit Titre</span></h3><!--end::Title-->
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<ul class="nav" id="kt_chart_widget_8_tabs" role="tablist">
									
									<li class="nav-item" role="presentation">
										<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1" data-bs-toggle="tab" href="#kt_chart_widget_8_week_tab" id="kt_chart_widget_8_week_toggle" aria-selected="false" role="tab" tabindex="-1">Page 1</a>
									</li>
									<li class="nav-item" role="presentation">
										<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 active" data-bs-toggle="tab" href="#kt_chart_widget_8_month_tab" id="kt_chart_widget_8_month_toggle" aria-selected="true" role="tab">Page 2</a>
									</li>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel" aria-labelledby="kt_chart_widget_8_week_toggle">
									...
									<div class="mb-5">
										...
										<div class="d-flex align-items-center mb-2">
											<span class="fs-1 fw-semibold text-gray-400 me-1 mt-n1">$</span> <span class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2">Page 2</span> <span class="badge badge-light-success fs-base"><i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1"><span class="path1"></span><span class="path2"></span></i> 4,8%</span>
										</div><!--end::Statistics-->
										<!--begin::Description-->
										<span class="fs-6 fw-semibold text-gray-400">Petit Texte</span> <!--end::Description-->
									</div><!--end::Statistics-->
									<!--begin::Chart-->
								...
								<div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab" role="tabpanel" aria-labelledby="kt_chart_widget_8_month_toggle">
									...
									<div class="mb-5">
										<!--begin::Statistics-->
										<div class="d-flex align-items-center mb-2">
											<span class="fs-1 fw-semibold text-gray-400 me-1 mt-n1">$</span> <span class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2">Page 1</span> <span class="badge badge-light-success fs-base"><i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1"><span class="path1"></span><span class="path2"></span></i> 2.2%</span>
										</div><!--end::Statistics-->
										<!--begin::Description-->
										<span class="fs-6 fw-semibold text-gray-400">Petit Texte</span> <!--end::Description-->
									</div><!--end::Statistics-->
				...
				<div class="col-xxl-6 mb-5 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-5">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column"><span class="card-label fw-bold text-gray-800">Titre</span> <span class="text-gray-400 mt-1 fw-semibold fs-6">Petit Titre</span></h3><!--end::Title-->
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								
								<!--begin::Menu-->
								 <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end" data-kt-menu-overflow="true" data-kt-menu-placement="bottom-end" data-kt-menu-trigger="click"><i class="ki-duotone ki-dots-square fs-1 text-gray-400 me-n1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i></button> <!--begin::Menu 2-->
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
									...
									<div class="menu-item px-3" data-kt-menu-placement="right-start" data-kt-menu-trigger="hover">
										<!--begin::Menu item-->
										 <a class="menu-link px-3" href="#"><span class="menu-title">New Group</span> <span class="menu-arrow"></span></a> <!--end::Menu item-->
										 <!--begin::Menu sub-->
						...
						<div class="card-body pt-6">
							...
							<ul class="nav nav-pills nav-pills-custom mb-3">
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									<!--begin::Link--> <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_1" id="kt_stats_widget_16_tab_link_1"><!--begin::Icon-->
									...
									<!--begin::Title-->
									 <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">Messages</span> <!--end::Title-->
									 <!--begin::Bullet-->
									 <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span> <!--end::Bullet--></a> <!--end::Link-->
								</li><!--end::Item--><!--begin::Item-->
								<li class="nav-item mb-3 me-3 me-lg-6">
									<!--begin::Link--> <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_2" id="kt_stats_widget_16_tab_link_2"><!--begin::Icon-->
									<div class="nav-icon mb-3">
										<i class="ki-duotone ki-bitcoin fs-1"><span class="path1"></span><span class="path2"></span></i>
									</div><!--end::Icon-->
									<!--begin::Title-->
									 <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">Perso</span> <!--end::Title-->
									 <!--begin::Bullet-->
									 <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span> <!--end::Bullet--></a> <!--end::Link-->
								</li><!--end::Item--><!--begin::Item-->
								<li class="nav-item mb-3 me-3 me-lg-6">
									<!--begin::Link--> <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_3" id="kt_stats_widget_16_tab_link_3"><!--begin::Icon-->
									<div class="nav-icon mb-3">
										<i class="ki-duotone ki-like fs-1"><span class="path1"></span><span class="path2"></span></i>
									</div><!--end::Icon-->
									<!--begin::Title-->
									 <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">De moi</span> <!--end::Title-->
									 <!--begin::Bullet-->
									 <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span> <!--end::Bullet--></a> <!--end::Link-->
								</li><!--end::Item--><!--begin::Item-->
								<li class="nav-item mb-3 me-3 me-lg-6">
									<!--begin::Link--> <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_4" id="kt_stats_widget_16_tab_link_4"><!--begin::Icon-->
									<div class="nav-icon mb-3">
										<i class="ki-duotone ki-tablet fs-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
									</div><!--end::Icon-->
									<!--begin::Title-->
									 <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">Corbeille</span> <!--end::Title-->
									 <!--begin::Bullet-->
									 <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span> <!--end::Bullet--></a> <!--end::Link-->
								</li><!--end::Item--><!--begin::Item-->
								<li class="nav-item mb-3 me-3 me-lg-6">
									<!--begin::Link--> <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" href="#kt_stats_widget_16_tab_5" id="kt_stats_widget_16_tab_link_5"><!--begin::Icon-->
									<div class="nav-icon mb-3">
										<i class="ki-duotone ki-send fs-1"><span class="path1"></span><span class="path2"></span></i>
									</div><!--end::Icon-->
									<!--begin::Title-->
									 <span class="nav-text text-gray-800 fw-bold fs-6 lh-1">Autres</span> <!--end::Title-->
									 <!--begin::Bullet-->
									 <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span> <!--end::Bullet--></a> <!--end::Link-->
								</li><!--end::Item-->
							</ul><!--end::Nav-->
							...
							<div class="tab-content">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
											...
											<thead>
												<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
													<th class="p-0 pb-3 min-w-150px text-start">Tout les derniers messages</th>
													<th class="p-0 pb-3 min-w-100px text-end pe-13">Date</th>
													<th class="p-0 pb-3 w-125px text-end pe-7">Message</th>
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-3.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Guy Hawkins</a> <span class="text-gray-400 fw-semibold d-block fs-7">Haiti</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">78.34%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_1_1"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												</tr>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-2.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Jane Cooper</a> <span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">63.83%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="danger" id="kt_table_widget_16_chart_1_2"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-9.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Jacob Jones</a> <span class="text-gray-400 fw-semibold d-block fs-7">Poland</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">92.56%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_1_3"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-7.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Cody Fishers</a> <span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">63.08%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_1_4"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
								...
								</div><!--end::Tap pane--><!--begin::Tap pane-->
								<div class="tab-pane fade" id="kt_stats_widget_16_tab_2">
									...
									<div class="table-responsive">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
											...
											<thead>
												<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
													<th class="p-0 pb-3 min-w-150px text-start">Mes messages</th>
													<th class="p-0 pb-3 min-w-100px text-end pe-13">Date.</th>
													<th class="p-0 pb-3 w-125px text-end pe-7">Message</th>
													<th class="p-0 pb-3 w-50px text-end">Voir</th>
												</tr>
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-25.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Brooklyn Simmons</a> <span class="text-gray-400 fw-semibold d-block fs-7">Poland</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">85.23%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_2_1"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-24.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Esther Howard</a> <span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">74.83%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="danger" id="kt_table_widget_16_chart_2_2"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-20.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Annette Black</a> <span class="text-gray-400 fw-semibold d-block fs-7">Haiti</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">90.06%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_2_3"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-17.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Marvin McKinney</a> <span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">54.08%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_2_4"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
										...
										<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-11.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Jacob Jones</a> <span class="text-gray-400 fw-semibold d-block fs-7">New York</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">52.34%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_3_1"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-23.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Ronald Richards</a> <span class="text-gray-400 fw-semibold d-block fs-7">Madrid</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">77.65%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="danger" id="kt_table_widget_16_chart_3_2"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-4.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Leslie Alexander</a> <span class="text-gray-400 fw-semibold d-block fs-7">Pune</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">82.47%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_3_3"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-1.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Courtney Henry</a> <span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">67.84%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_3_4"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
										...
										<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-12.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Arlene McCoy</a> <span class="text-gray-400 fw-semibold d-block fs-7">London</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">53.44%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_4_1"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-21.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Marvin McKinneyr</a> <span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">74.64%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="danger" id="kt_table_widget_16_chart_4_2"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-30.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Jacob Jones</a> <span class="text-gray-400 fw-semibold d-block fs-7">PManila</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">88.56%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_4_3"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-14.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Esther Howard</a> <span class="text-gray-400 fw-semibold d-block fs-7">Iceland</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">63.16%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_4_4"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
										...
										<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-6.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Jane Cooper</a> <span class="text-gray-400 fw-semibold d-block fs-7">Haiti</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">68.54%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_5_1"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-10.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Esther Howard</a> <span class="text-gray-400 fw-semibold d-block fs-7">Kiribati</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">55.83%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="danger" id="kt_table_widget_16_chart_5_2"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													...
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">93.46%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_5_3"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
												...
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="symbol symbol-50px me-3"><img alt="" class="" src="assets/media/avatars/300-3.jpg"></div>
															<div class="d-flex justify-content-start flex-column">
																<a class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" href="pages/user-profile/overview.html">Ralph Edwards</a> <span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
															</div>
														</div>
													</td>
													<td class="text-end pe-13"><span class="text-gray-600 fw-bold fs-6">64.48%</span></td>
													<td class="text-end pe-0">
														<div class="h-50px mt-n8 pe-7" data-kt-chart-color="success" id="kt_table_widget_16_chart_5_4"></div>
													</td>
													<td class="text-end">
														<a class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px" href="#"><i class="ki-duotone ki-black-right fs-2 text-gray-500"></i></a>
													</td>
								...
								</div><!--end::Tap pane--><!--end::Table container-->
							</div><!--end::Tab Content-->
						
						
						
						</div><!--end: Card Body-->
					</div><!--end::Tables widget 16-->
				</div><!--end::Col-->
					...
					<div class="card card-flush h-md-50 mb-5 mb-xl-10">
						...
						<div class="card-header pt-5">
							...
							<div class="card-title d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									<!--begin::Currency-->
									<span class="fs-4 fw-semibold text-gray-400 me-1 align-self-start">XD</span> <!--end::Currency-->
									 <!--begin::Amount-->
									 <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">Titre</span> <!--end::Amount-->
									 <!--begin::Badge-->
									 <span class="badge badge-light-success fs-base">
										<i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1"><span class="path1"></span><span class="path2"></span></i> Option
									</span> <!--end::Badge-->
								</div><!--end::Info--><!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-semibold fs-6">Expected Earnings</span> <!--end::Subtitle-->
							</div><!--end::Title-->
						</div>
						<!--end::Header-->
								...
								<div class="d-flex align-items-center">
									...
									<span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">Titre</span> <!--end::Amount-->
									 ...
									 <span class="badge badge-light-danger fs-base">
										<i class="ki-duotone ki-arrow-down fs-5 text-danger ms-n1"><span class="path1"></span><span class="path2"></span></i> Option
									</span> <!--end::Badge-->
								</div><!--end::Info--><!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-semibold fs-6">Petit Titre</span> <!--end::Subtitle-->
							</div><!--end::Title-->
						</div>
						<!--end::Header-->
				...
				<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
							...
							<div class="card-title d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									...
									<span class="fs-4 fw-semibold text-gray-400 me-1 align-self-start">XD</span> <!--end::Currency-->
									 ...
									 <!--begin::Badge-->
									 <span class="badge badge-light-success fs-base">
										<i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1"><span class="path1"></span><span class="path2"></span></i> Option</span> <!--end::Badge-->
								</div><!--end::Info--><!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-semibold fs-6">Petit Titre</span> <!--end::Subtitle-->
							</div><!--end::Title-->
						</div><!--end::Header-->
					...
					<div class="card card-flush h-md-50 mb-xl-10">
						...
						<div class="card-header pt-5">
							...
							<div class="card-title d-flex flex-column">
								<!--begin::Amount-->
								<span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">Titre</span> <!--end::Amount--> <!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-semibold fs-6">Petit titre</span> <!--end::Subtitle-->
							</div><!--end::Title-->
						</div><!--end::Header-->
						<!--begin::Card body-->
						<div class="card-body d-flex flex-column justify-content-end pe-0">
							<!--begin::Title-->
							<span class="fs-6 fw-bolder text-gray-800 d-block mb-2">Liste des personnes en ligne</span> <!--end::Title-->
							 <!--begin::Users group-->
							<div class="symbol-group symbol-hover flex-nowrap">
								<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Alan Warden">
									<span class="symbol-label bg-warning text-inverse-warning fw-bold">A</span>
								</div>
								<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon"><img alt="Pic" src="assets/media/avatars/300-11.jpg"></div>
								<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
									<span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
								</div>
								<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy"><img alt="Pic" src="assets/media/avatars/300-2.jpg"></div>
								<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Perry Matthew">
									<span class="symbol-label bg-danger text-inverse-danger fw-bold">P</span>
								</div>
								<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
									<img alt="Pic" src="assets/media/avatars/300-12.jpg"></div>
									<a class="symbol symbol-35px symbol-circle" data-bs-target="#kt_modal_view_users" data-bs-toggle="modal" href="#">
										<span class="symbol-label bg-light text-gray-400 fs-8 fw-bold">??</span>
									</a>
							</div><!--end::Users group-->
						</div><!--end::Card body-->
					</div><!--end::Card widget 7-->
				</div>
				<!--end::Col-->
					...
					<div class="card card-flush overflow-hidden h-md-100">
						...
						<div class="card-header py-5">
							...
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label fw-bold text-dark">Titre</span> 
								<span class="text-gray-400 mt-1 fw-semibold fs-6">Petit Titre</span>
							</h3><!--end::Title-->
							
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<!--begin::Menu-->
								 <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end" data-kt-menu-overflow="true" data-kt-menu-placement="bottom-end" data-kt-menu-trigger="click"><i class="ki-duotone ki-dots-square fs-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i></button> <!--begin::Menu 2-->
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<div class="menu-content fs-6 text-dark fw-bold px-3 py-4">
				...
				<div class="col-xl-4">
					...
					<div class="card h-md-100" dir="ltr">
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="mb-2">
								<!--begin::Title-->
								<h1 class="fw-semibold text-gray-800 text-center lh-lg">Faire une demande<br> au support</h1><!--end::Title--><!--begin::Illustration-->
								<div class="py-10 text-center"><img alt="" class="theme-light-show w-200px" src="assets/media/svg/illustrations/easy/2.svg"> <img alt="" class="theme-dark-show w-200px" src="assets/media/svg/illustrations/easy/2-dark.svg"></div><!--end::Illustration-->
							</div><!--end::Heading-->
							<!--begin::Links-->
							<div class="text-center mb-1">
								<!--begin::Link-->
								 <a class="btn btn-sm btn-primary me-2" href="apps/ecommerce/customers/listing.html">Faire une demande </a> <!--end::Link-->
								 <!--begin::Link-->
								 <a class="btn btn-sm btn-light" href="apps/invoices/view/invoice-1.html">Afficher les questions</a> <!--end::Link-->
							</div><!--end::Links-->
						</div><!--end::Body-->
					</div><!--end::Engage widget 1-->
				</div><!--end::Col-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-flush h-md-100">
						...
						<div class="card-header flex-nowrap pt-5">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column"><span class="card-label fw-bold text-dark">Titre </span> <span class="text-gray-400 pt-2 fw-semibold fs-6">Petit Titre</span></h3><!--end::Title-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-flush h-md-100">
						...
						<div class="card-header pt-7">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label fw-bold text-gray-800">Titre</span> 
								<span class="text-gray-400 mt-1 fw-semibold fs-6">Petit Titre</span>
							</h3><!--end::Title-->
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a class="btn btn-sm btn-light" href="apps/ecommerce/catalog/categories.html">Ouvrir</a>
							</div><!--end::Toolbar-->
						</div><!--end::Header-->
						<!--begin::Body-->
...
<!-- ********************************************************************************************************************************** -->              
	<div class="app-footer align-items-center justify-content-center justify-content-md-between flex-column flex-md-row py-3" id="kt_app_footer">
		...
		<div class="text-dark order-2 order-md-1">
			<span class="text-muted fw-semibold me-1">ZeCrusher&copy;</span> <a class="text-gray-800 text-hover-primary" href="https://keenthemes.com/" target="_blank">GitHub</a>
		</div><!--end::Copyright-->
		<!--begin::Menu-->
		<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
			<li class="menu-item">
				<a class="menu-link px-2" href="https://keenthemes.com/" target="_blank">Instagram</a>
			</li>
			<li class="menu-item">
				<a class="menu-link px-2" href="https://devs.keenthemes.com/" target="_blank">Facebook</a>
			</li>
			<li class="menu-item">
				<a class="menu-link px-2" href="https://keenthemes.com/products/saul-html-pro" target="_blank">Google</a>
			</li>
		</ul><!--end::Menu-->
	</div>
...
<!--begin::aside-->
	<div class="app-aside flex-column" data-kt-drawer="true" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-direction="end" data-kt-drawer-name="app-aside" data-kt-drawer-overlay="true" data-kt-drawer-toggle="#kt_app_aside_mobile_toggle" data-kt-drawer-width="auto" id="kt_app_aside">
		<!--begin::Wrapper-->
		<div class="d-flex flex-column align-items-center hover-scroll-y py-5 py-lg-0 gap-4" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-dependencies="#kt_app_header" data-kt-scroll-height="auto" data-kt-scroll-offset="5px" data-kt-scroll-wrappers="#kt_app_aside_wrapper" id="kt_app_aside_wrapper">
			<a class="btn btn-icon btn-color-primary bg-hover-body h-45px w-45px flex-shrink-0 mb-4" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip" href="apps/calendar.html" title="Calendar"><i class="ki-duotone ki-calendar-add fs-2qx"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></i></a> <a class="btn btn-icon btn-color-warning bg-hover-body h-45px w-45px flex-shrink-0 mb-4" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip" href="account/overview.html" title="Profile"><i class="ki-duotone ki-message-add fs-2qx"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></a> <a class="btn btn-icon btn-color-info bg-hover-body h-45px w-45px flex-shrink-0 mb-4" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip" href="apps/ecommerce/catalog/products.html" title="Products"><i class="ki-duotone ki-devices-2 fs-2qx"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></a>
		</div><!--end::Wrapper-->
	</div>
<!--end::aside-->                
...
<!--end::Card header-->
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content" 
				...
				<!--begin::Form-->
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="https://preview.keenthemes.com/saul-html-pro/index.php">
...
<div class="form-group">
	...
	<div class="mb-6">
		...
		<div class="fw-semibold text-muted fs-7 d-block lh-1">
			...
			<a class="fw-semibold" href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/dark-mode" target="_blank">See docs</a>
		</div>
	</div>
	<!--end::Heading-->  
...
<div class="form-group d-flex flex-stack">           
	...
	<div class="d-flex flex-column">
		...
		<div class="fs-7 fw-semibold text-muted">
			...
			<a class="fw-semibold" href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/rtl" target="_blank">See docs</a>
		</div>	
	</div>
	<!--end::Heading-->
...
<div class="form-group ">            
	...
	<div class="d-flex flex-column mb-4">
		...
		<div>
			...
			<a class="fw-semibold" href="https://preview.keenthemes.com/html/saul-html-pro/docs/icons/keenicons" target="_blank">Learn more</a>
		</div>
	</div>
	<!--end::Heading-->
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/saul-html-pro/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/doc.svg"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/saul-html-pro/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/css.svg"/>
                    <!--end::Icon--> 
...
<div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
    ...
    <!--begin::Purchase-->
    <div class="mb-7">
        <a href="https:" class="btn btn-lg explore-btn-primary w-100">					
            Support
        </a>
    </div>
    <!--end::Purchase-->
    ...
    <div class="d-flex flex-column flex-center mb-3">
        ...
        <div class="mb-3 text-gray-500 fw-semibold fs-6">
            Secured Payment by <a href="https://www.2checkout.com/" target="_black" class="fw-bold text-dark explore-link-hover me-1">2Checkout</a> with: 
        </div>
        <!--end::Heading-->
		...
		<div class="card-body" id="kt_help_body">
			...
			<div 
				...
				<!--end::Support-->
														...
														<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/saul-html-pro/docs"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
					...
					<!--end::Link-->
														<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/saul-html-pro/docs/base/utilities"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
					...
					<!--end::Link-->
																			<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/changelog"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
...
<!--end::Modals-->
	...
	<!-- En test pour le moment -->
		<script src="assets/js/themes/Animated.js"></script>
	<!-- En test pour le moment -->
...
<!--		<script src="assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		...
		<script src="assets/js/geodata/worldLow.js"></script>
		<script src="assets/js/geodata/continentsLow.js"></script>
		<script src="assets/js/geodata/usaLow.js"></script>
		<script src="assets/js/geodata/worldTimeZonesLow.js"></script>
		<script src="assets/js/geodata/worldTimeZoneAreasLow.js"></script>
